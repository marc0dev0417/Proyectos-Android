...
/**
 * The type Actividad grabar video.
 */
public class ActividadGrabarVideo extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initRecorder();
        setContentView(R.layout.actividad_grabar_video);
        ...
        btnReproducir.setOnClickListener(v -> {
            ...
            Intent actividadReproducir = new Intent(getApplicationContext(), ActividadReproducirVideo.class);
