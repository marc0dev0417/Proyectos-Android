...
public class ActividadImagenAnimada extends AppCompatActivity {
    ...
    private int anchura;
    private int altura;
    private ArrayList<String> listaSonido;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load(urlImagen.getStringExtra("urlImagen")).into(imageUrlCargada);

        listaSonido = new ArrayList<>(urlImagen.getStringArrayListExtra("listaImportada"));
        ...
        btnGrabarAudio.setOnClickListener(v -> {
            ...
            actividadListaAudioImagen.putStringArrayListExtra("listaImagenes", listaSonido);
